...
public class PlayerController : MonoBehaviour
{
        ...
        void Update()
        {
            ...
            {
                var mouseMovement = GetInputLookRotation() * 0.01f * mouseSensitivity; //0.01 to reduce the effect
                if (invertY)
            ...
            // You can increase the boost by using the mouse scroll wheel
        ...
        /**
            Only allow player to move camera when the right button of the mouse
            is pressed.
        **/
